...
const INPUT_MIN = `.button.base{background-color: #FFFFFF;&:not(.active):hover{background-color: hsl(0,0%,97%);}&.active,&:active{background-color: hsl(0,0%,94%);}color: #1F1F1F;border-color: hsl(0,0%,85.5%);}`;

const OUTPUT_MIN = `.button.base{background-color: #FFFFFF;color: #1F1F1F;border-color: hsl(0,0%,85.5%);&:not(.active):hover{background-color: hsl(0,0%,97%);}&.active,&:active{background-color: hsl(0,0%,94%);}}`;
...
module.exports = {INPUT, INPUT_MIN, OUTPUT, OUTPUT_MIN, AST};
